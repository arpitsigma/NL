						...
						<?php else: ?>
							<div id="product-video-bg" style="background: url('<?php echo get_post_thumbnail_src( 'origin_size' ); ?>') center top no-repeat; background-size: cover;">
							  <div class="p-main-visual__video">
								<div class="player" data-property="{videoURL:'eO58zmI7vvc', containment:'.p-main-visual__video', autoPlay:true, loop:true, mute:true, startAt:0, opacity:1, showControls: false, showYTLogo: false, gaTrack: false, quality: 'highres', useOnMobile: true}"></div>
							  </div>
							</div>
