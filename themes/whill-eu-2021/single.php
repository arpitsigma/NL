	...
	<main role="main">
		...
		<div class="p-band p-band_primary">
			<div class="c-container c-container_full">
              ...
              <?php
                if ($isNewletter) {
                  ?>
                  <h2 class="p-page-header__title">Newsletters</h2>
                  <?php
                } else {
                  ?>
		...
		<div class="p-page-sub-navigation"  data-sub-navigation-container>
            ...
            <?php
              if ($isNewletter) {
                ?>
                <li class="p-sub-navigation__item"><a href="<?php echo site_url('/newsletters/'); ?>"><i class="fa fa-angle-left fa-lg fa-fw"></i>Back</a></li>
                <?php
              } else {
                ?>
