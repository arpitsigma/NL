...
require dirname( __FILE__ ) . '/lib/Software_Short_Code.php';
require dirname( __FILE__ ) . '/lib/Assets.php';
require dirname( __FILE__ ) . '/lib/Support.php';

use WHILL\Assets;
use WHILL\Image;
use WHILL\Software_Short_Code;
use WHILL\Support;
use WHILL\Tiny_MCE;
...
function theme_setup() {
	...
	new Tiny_MCE();
	new Support();
	new Software_Short_Code();

	register_nav_menus( array(
		'primary' => __( 'Top Primary Menu' ),
		'footer_menu' =>  __( 'Footer Menu' ),
    'secondary' =>  __( 'Footer Links' ),
		'brandhub_top' =>  __( 'Brand Hub Top' ),
		'brandhub_side' =>  __( 'Brand Hub Side' ),
	) );
