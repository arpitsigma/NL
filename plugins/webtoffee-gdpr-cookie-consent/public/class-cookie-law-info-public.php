	...
	public function cookielawinfo_inject_cli_script() 
	{
		...
		if ( $the_options['is_on'] == true ) 
	  	{             
			...
			$message = nl2br('<div class="wt-cli-template cli-style-v3"><p>Wij gebruiken cookies en soortgelijke hulpmiddelen die nodig zijn om de website te gebruiken en uw gebruikerservaring te verbeteren. Deze cookies worden ook gebruikt om te begrijpen hoe klanten onze diensten gebruiken, zodat deze kunnen worden verbeterd.</p><p>Door op "Alle cookies accepteren" te klikken, stemt u in met het opslaan van cookies op uw apparaat voor deze doeleinden. Zie de cookie-instellingen voor meer details.</p><div class="cli-bar-actions"><div class="cli-bar-btn_container">[cookie_button][cookie_settings]</div></div></div>
</div>');
