...
class Cookie_Law_Info_Shortcode {
    ...
    */
    ...
    {   
        ...
        { 
            $checked = '';
            if(isset($cookie['defaultstate']) && $cookie['defaultstate']== 'enabled')
            {   
                $checked = 'checked';     
            }
    ...
    */
    public function cookielawinfo_table_shortcode( $atts )
    {
        ...
        */
        ...
        {
            $ret .= '<th scope="col" class="cookielawinfo-column-1">'.__('Cookie', 'cookie-law-info').'</th>';
        }
        if(in_array('type',$columns))
        {       
            $ret .= '<th scope="col" class="cookielawinfo-column-2">'.__('Type', 'cookie-law-info').'</th>';
        }
        if(in_array('duration',$columns))
        {
            $ret .= '<th scope="col" class="cookielawinfo-column-3">'.__('Duration', 'cookie-law-info').'</th>';
        }
        if(in_array('description',$columns))
        {
            $ret .= '<th scope="col" class="cookielawinfo-column-4">'.__('Description', 'cookie-law-info').'</th>';
        }
