    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                ...
                ?>
                <span class="cli_form_help"><?php _e('Shortcodes allowed: see the Help guide', 'cookie-law-info'); ?> <br /><?php _e('Examples: "We use cookies on this website [cookie_accept] to find out how to delete cookies [cookie_link]."', 'cookie-law-info'); ?></span>
            </td>
        </tr>
        <tr valign="top">
