	...
	<div class="cookie-law-info-form-container">
		<div class="cli-plugin-toolbar top">
	        ...
	        <div class="right" style="padding-top: 10px; margin-right: 0px;">
				...
				{
				?>
					<a class="button-secondary pull-right cli_export" style="margin-left:5px;" href="<?php print wp_nonce_url($export_page_url.$scan_details['id_cli_cookie_scan'], 'cli_cookie_scaner', 'cli_cookie_scaner');?>"><?php _e('Download cookies as CSV', 'cookie-law-info'); ?></a>
