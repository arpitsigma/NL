=== weLaunch - Gutenberg Blocks Library & Framework ===
Contributors: dovyp, welaunch
Donate link: https://paypal.me/weLaunchFramework
...
== Description ==
<strong>weLaunch - Quickly create full pages in WordPress’ Gutenberg</strong>
...
You are building a **big site** with **lots of pages** and you just want it to look amazing. With weLaunch you can begin making pages with a variety of "starter blocks," or templates.

You can browse through the categories, as well as collections of like-styled pages. When you find something you like, weLaunch makes sure you have everything you need. If a dependency (or required plugin) is missing, you are notified and can install the missing dependency. Worried that our templates may not work with your theme? No problem! With our custom `page templates` options you can transform any site into exactly what you want it to be no matter what them you are using.
...
Currently weLaunch supports only the <a href="https://wordpress.org/plugins/gutenberg/"><strong>Gutenberg / Block Editor of WordPress 5.0+</strong></a>.

<h4>🎨 Supported Themes</h4>
Though weLaunch will work with any theme that uses Gutenberg, we have done extra work to ensure complete compatibility with these themes.
...
If you want to translate, <a href="https://translate.wordpress.org/projects/wp-plugins/welaunch-framework">go to the Translation Portal at translate.wordpress.org</a>.

You can also contribute code-wise via our <a href="https://github.com/welaunchframework/welaunch-framework-4/">GitHub Repository</a> – and see where you can help. Be sure to use our develop branch to submit pull requests.

<h4>📝 Documentation and Support</h4>
<ul>
<li>For more information about features, FAQs and documentation, check out our website at <a href="https://docs.welaunch.io/" rel="nofollow ugc">weLaunch</a>.</li>
<li>If you have any more questions, visit our support on the <a href="https://wordpress.org/support/plugin/welaunch-framework">Plugin's Forum</a>.</li>
</ul>

<h4>⚡ Like the weLaunch Plugin?</h4>
<ul>
<li>Follow us on <a href="https://www.facebook.com/welaunchframework" rel="nofollow ugc">Facebook 💬</a></li>
<li><strong>Rate us 5 ⭐ stars</strong> on <a href="https://wordpress.org/support/plugin/welaunch-framework/reviews/?filter=5/#new-post">WordPress.org</a></li>
...
<li>Follow us on Twitter 🐦: <a href="https://twitter.com/welaunchframework" rel="nofollow ugc">@weLaunchFramework</a> and <a href="https://twitter.com/dovyp" rel="nofollow ugc">@DovyP</a></li>
</ul>

<h4>🔐 Privacy</h4>
weLaunch does not interact with end users on your website. Our templates will continue to work even if weLaunch is uninstalled. If a product is using weLaunch the option panel will cease to function without weLaunch.

weLaunch utilizes [AppSero](https://appsero.com/) for account management as well as to enable our premium offerings. You can find their privacy policy here: [https://appsero.com/privacy-policy/](https://appsero.com/privacy-policy/). Activation of weLaunch is not necessary, but additional features such as Google Font Updates and increased access to the template library will be limited.

The weLaunch plugin uses a custom API to fetch our content library and our Gutenberg templates. To improve the service and stability we store logs which may or may not contain the following:
<ul>
<li>browser type</li>
...
<li>version of weLaunch installed</li>
<li>weLaunch API keys</li>
</ul>

API requests are only made when a user clicks on the Library button, launches the weLaunch Challenge, or opts into Google Font updates.

For more details on our privacy policy: [https://welaunch.io/privacy](https://welaunch.io/privacy)
For more details on on our terms and conditions: [https://welaunch.io/terms](https://welaunch.io/terms)

== Installation ==
1. Upload the entire plugin folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.

Once Installed and Activated you will be invited to Activate your weLaunch account. This is entirely voluntary and can easily be dismissed.
...
1. With weLaunch you have access to hundreds of sections to help you create any type of page.
2. Take the weLaunch challenge to learn your way around the weLaunch Templates Library.
...
* Fixed: Static call mismatch in welaunch colors.
...
* Fixed: Pro template count error if previously activated and weLaunch Pro not enabled.
...
* Added: Broke out third-party premium plugins for filtering to help with understanding of what comes with weLaunch Pro.
* Added: Update block editor width when selecting a weLaunch template.
...
* Fixed: Issue where crash would occur when weLaunch could not write out a file.
* Fixed: CSS selectors with HTML entities, like >, were not getting decoded for the passed compiler values.
* Fixed: weLaunch Pro activation issue.
* Fixed: Invalid logic causing some extensions not to run.
* Release date: Sep 18, 2020

** For a full changelog, see https://github.com/welaunchframework/welaunch-framework-4/blob/master/CHANGELOG.md **

== Frequently Asked Questions ==

= Who should use the weLaunch Block Library for Gutenberg? =

The weLaunch Block Library for Gutenberg is a complete package of unique and creative templates that will help you build beautiful pages and posts on a website. It is of value for everyone and for all who love Gutenberg.

= What are the requirements to use the weLaunch Library for Gutenberg? =

You only need to have the latest version of WordPress on your website, to begin with. weLaunch is for Gutenberg is basically an addon for the default WordPress block editor. Therefore, the latest WordPress installation along with a theme should be enough, to begin with.

= What themes does weLaunch Library for Gutenberg work with? =

weLaunch is built to work wonderfully with all themes.

= Can I use weLaunch for Gutenberg even while having another Page Builder? =

The basic need or requirement for weLaunch for Gutenberg is the latest WordPress version. Should you need help, you can <a href="https://welaunch.io/contact/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme" target="_blank" rel="">get in touch with us.</a>

= Can I use weLaunch for Gutenberg on client websites? =

Yes! You can certainly use weLaunch on yours as well as your client's websites.

= Will weLaunch slow down my website? =

Absolutely not! The weLaunch Library for Gutenberg plugin is built with ease and performance in mind. Its module architecture and the clean code keep it extremely fast. Every performance issue that seems to be coming from weLaunch is actually the integration code of third-party developers. If you're having issues let us know and we'll try to help you out.
