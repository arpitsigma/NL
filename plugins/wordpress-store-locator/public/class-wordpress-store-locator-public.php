...
class WordPress_Store_Locator_Public
{
    ...
    public function stores_single_content($content) 
    {
        ...
        $content = $categories . $filter . $content . $address . $contact . $additional_information . $opening_hours . $opening_hours2 . $contactStore . $review . $map;
        ...
        <div id="store_locator" class="store-locator-container-fluid store_locator modal-body">
            <div class="store-locator-row">
                ...
                <?php } elseif($layout == 8) { 
                    ...
                    // Save orignal and overrride
                    $resultListColumns = $this->options['resultListColumns'];
                    $searchBoxColumns = $this->options['searchBoxColumns'];

                    $this->options['resultListColumns'] = '12';
                    $this->options['searchBoxColumns'] = '12';
                    ?>
                    <div class="store-locator-col-md-<?php echo $resultListColumns ?>">
                        <div class="store-locator-row">
                            <?php $this->get_sidebar_content(); ?>
                        </div>
                    </div>
                    <div class="store-locator-col-md-<?php echo $searchBoxColumns ?>">
                        <div class="store-locator-row">
                            <?php $this->get_search_box(); ?>
                            <?php $this->get_map(); ?>
                        </div>
    ...
    {   
        ...
        <div class="store-locator-row">
            <div class="store-locator-col-12 store-locator-col-sm-12">
                ...
                <input id="store_locator_address_field" class="store_locator_address_field" type="text" name="location" placeholder="<?php echo $searchBoxAddressPlaceholder ?>">
            </div>
        </div>
        <?php
    }
